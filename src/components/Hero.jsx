...
const Hero = () => {
    return (
        <div name="home" className="h-screen w-full relative overflow-hidden flex items-center justify-center">

            {/* Background Elements */}
            <div className="absolute top-20 right-20 w-72 h-72 bg-primary/20 rounded-full blur-[100px] z-0 animate-pulse"></div>
            <div className="absolute bottom-20 left-20 w-96 h-96 bg-secondary/20 rounded-full blur-[100px] z-0 animate-pulse delay-700"></div>

            <div className="max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row items-center justify-center h-full px-8 z-10 gap-12">
                ...
                <div className="flex flex-col justify-center h-full w-full md:w-1/2 space-y-6">
                    ...
                    <motion.div
                        ...
                        className="w-fit"
                    >
                        <div className="glass px-4 py-1 rounded-full border border-primary/30 text-primary text-sm font-mono tracking-widest uppercase flex items-center gap-2">
                    ...
                    >
                        <Link
                            ...
                            smooth={true}
                            duration={500}
                            className="group text-white px-8 py-3 flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary to-secondary cursor-pointer hover:scale-105 transition-all duration-300 shadow-[0_0_30px_rgba(139,92,246,0.3)] hover:shadow-[0_0_50px_rgba(139,92,246,0.5)] border border-transparent"
                        >
                            View Projects
                        ...
                        <Link
                            ...
                            smooth={true}
                            duration={500}
                            className="text-white px-8 py-3 rounded-lg border border-white/20 hover:bg-white/5 cursor-pointer hover:scale-105 transition-all duration-300 backdrop-blur-sm"
                        >
                            Contact Me
                        </Link>
                    </motion.div>
                ...
                >
                    <div className="relative w-72 h-72 md:w-[450px] md:h-[450px] group">
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-6 -right-6 glass px-6 py-4 rounded-2xl z-30 flex items-center gap-4"
                        >
