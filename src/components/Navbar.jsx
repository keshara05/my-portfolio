...
const Navbar = () => {
    ...
    return (
        <nav
            className={`fixed w-full left-0 z-50 transition-all duration-300 ${nav ? "h-[70px] bg-transparent" : scrolled ? "glass h-[70px] shadow-lg top-0" : "h-[90px] bg-transparent top-0"
                }`}
        >
